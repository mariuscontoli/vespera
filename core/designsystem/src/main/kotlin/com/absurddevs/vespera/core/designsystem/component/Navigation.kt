...
fun VesperaNavigationRailItem(
    ...
    NavigationRailItem(
        ...
        colors = NavigationRailItemDefaults.colors(
            selectedIconColor = VesperaNavigationDefaults.navigationSelectedItemColor(),
            unselectedIconColor = VesperaNavigationDefaults.navigationContentColor(),
            selectedTextColor = VesperaNavigationDefaults.navigationSelectedItemColor(),
            unselectedTextColor = VesperaNavigationDefaults.navigationContentColor(),
            indicatorColor = VesperaNavigationDefaults.navigationIndicatorColor(),
        ),
    )
}

/**
 * Vespera navigation rail with header and content slots. Wraps Material 3
 * [NavigationRail].
 *
 * @param modifier Modifier to be applied to the navigation rail.
 * @param header Optional header that may hold floating action button or a logo.
 * @param content Destinations inside the navigation rail. This should contain multiple
 * [NavigationRailItem]s.
 */
@Composable
fun VesperaNavigationRail(
    modifier: Modifier = Modifier,
